    ...
    public class CuentasController : CustomBaseController
        {
            ...
            {
                // Construye un JWT simple: agrega claims (información del usuario), firma con la clave
                // y devuelve el token que el cliente debe enviar en el header Authorization.
